...
void reorder(float* oldPos, float* oldVel, float* olddensity, float* oldpressure, int* oldparticle_type, int* oldparticle_zone, float* sortedPos, float* sortedVel, float* sorteddensity, float* sortedpressure, int* sortedparticle_type, int* sortedparticle_zone, int* particleHash, int* particleIndex, int* dcellStart, int* dCellEnd, int numParticles, SimParams* temps)
{
    ...
    reorderD << < numBlocks, numThreads >> > (particleHash, particleIndex, dcellStart, dCellEnd, oldPos, oldVel, olddensity, oldpressure, oldparticle_type, oldparticle_zone, sortedPos, sortedVel, sorteddensity, sortedpressure, sortedparticle_type, sortedparticle_zone);
